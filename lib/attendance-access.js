...
const { listFingerprintMappings, fingerprintAttendanceById, planManualFingerprintRows,
...
async function handleAttendanceAccess(req, res, body = {}) {
  ...
  try {
    ...
    if (['attendance_mapping_list', 'attendance_mapping_save', 'attendance_mapping_revoke'].includes(body.action)) {
