...
async function loadAttendance(context, filters, dependencies = {}) {
  ...
  try {
    ...
    if (missingRows.length) await migrateToSupabase(missingRows);
...
module.exports = { handleAttendanceAccess, firestoreAttendance, loadAttendance, writeAttendance, removeAttendance, attendanceIdentity, dedupeAttendanceRows };
