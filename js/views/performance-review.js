...
async function renderMyReviews(wrap, session) {
 ...
 ${icon('printer', 'w-4 h-4')} Cetak Review
 </button>
 ...
 <h4 class="text-xs font-bold text-emerald-800 uppercase tracking-wide flex items-center gap-1.5">
 ${icon('star', 'w-4 h-4 text-emerald-700')} Kelebihan / Kekuatan Utama
 </h4>
 ...
 <h4 class="text-xs font-bold text-rose-800 uppercase tracking-wide flex items-center gap-1.5">
 ${icon('settings', 'w-4 h-4 text-rose-700')} Area Pengembangan / Kekurangan
 </h4>
