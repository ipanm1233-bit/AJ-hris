...
export async function mount(container, { session }) {
 ...
 <button type="button" class="kb-delete text-slate-300 hover:text-red-600 transition" title="Hapus baris ini">&times;</button>
 </td>
 `;
 ...
 <div class="w-16 h-16 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto text-3xl font-bold">[v]</div>
 <div>
 ...
 <button id="btn-print-success-klaim" class="px-5 py-2.5 bg-emerald-700 text-white rounded-lg text-xs font-bold hover:bg-emerald-800 transition shadow-md flex items-center gap-1.5">Cetak / Download Form Klaim (PDF)</button>
 </div>
 `,
 onMount: (m) => {
