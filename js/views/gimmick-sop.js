...
export async function mount(container) {
 ...
 openModal({
 title: ` Builder Langkah SOP & Category: ${sop.judul}`,
 size: "lg",
 bodyHtml: `
 ...
 <div>
 <label class="block font-bold text-emerald-800 mb-1">[v] Cabang YA / DISETUJUI</label>
 ...
 <div>
 <label class="block font-bold text-rose-800 mb-1">&times; Cabang TIDAK / DITOLAK</label>
