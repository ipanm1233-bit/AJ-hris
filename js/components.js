...
export function openPenilaianFormFromNotif(task, kpis, session) {
 ...
 <span><i class='fa-solid fa-thumbtack' aria-hidden='true'></i></span> Instruksi Khusus HRD untuk Evaluasi ini:
 </span>
 ...
 <div>
 <label class="block text-[11px] font-bold text-emerald-800 mb-1"><i class='fa-solid fa-star' aria-hidden='true'></i> Hal-Hal yang Sudah Baik (Kelebihan / Pencapaian):</label>
 ...
 <div>
 <label class="block text-[11px] font-bold text-rose-800 mb-1"><i class='fa-solid fa-bullseye' aria-hidden='true'></i> Area yang Perlu Ditingkatkan (Evaluasi Peningkatan):</label>
 ...
 <div>
 <label class="block text-[11px] font-bold text-slate-700 mb-1"><i class='fa-solid fa-pen' aria-hidden='true'></i> Catatan & Rekomendasi Tambahan:</label>
 ...
 <span><i class='fa-solid fa-check' aria-hidden='true'></i></span> Kirim Penilaian Kinerja
 </button>
 </div>
 </div>
 `,
