...
const APP_ASSET_VERSION = "20260923-attendance-fingerprint-v5";
...
function bindShellEvents(session) {
 ...
 ${icon("user-plus", "w-5 h-5 text-slate-500 shrink-0")}
 <div>
 ...
 ${icon("settings", "w-5 h-5 text-slate-500 shrink-0")}
 <div>
 ...
 ${icon("logout", "w-5 h-5 text-red-600 shrink-0")}
 <div>
